...
render_CV:
	...
	Rscript -e 'rmarkdown::render("rmarkdown/resume.Rmd", output_dir = "output/github-pages")'

.PHONY: print_CV
print_CV: render_CV
	Rscript -e 'pagedown::chrome_print("output/github-pages/CV.html", output = "output/print/CV.pdf", extra_args = "--no-sandbox")'
	Rscript -e 'pagedown::chrome_print("output/github-pages/resume.html", output = "output/print/resume.pdf", extra_args = "--no-sandbox")'
